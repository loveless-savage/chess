...
public class EscapeSequences {
    ...
    public static final String SET_TEXT_COLOR_MED_GREY = SET_TEXT_COLOR + "238m";
    ...
    public static final String SET_BG_COLOR_MED_GREY = SET_BG_COLOR + "238m";
    ...
    public static final String SET_BG_COLOR_BLUE = SET_BG_COLOR + "27m";
